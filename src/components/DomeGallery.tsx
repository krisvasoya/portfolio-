...
type ImageItem = string | ImageData;
...
function buildItems(pool: ImageItem[], seg: number): GridItem[] {
...
export const DomeGallery: React.FC<DomeGalleryProps> = ({
  ...
  const openItemFromElement = useCallback(
    (el: HTMLElement) => {
      ...
      const isCard = rawSrc.includes('github-readme-stats') || rawSrc.includes('streak-stats') || rawSrc.includes('skillicons');
      overlay.style.backgroundColor = isCard ? '#0d1117' : 'transparent';
      overlay.style.padding = isCard ? '20px' : '0';
      const img = document.createElement('img');
      img.src = rawSrc;
      img.style.objectFit = isCard ? 'contain' : 'cover';
      img.style.width = '100%';
        ...
        <div className="stage">
          <div ref={sphereRef} className="sphere">
            {items.map((it, i) => (
              ...
              >
                <div
                  className="item__image interactive"
                  role="button"
                  tabIndex={0}
                  ...
                  style={{
                    backgroundColor: (it.src.includes('github-readme-stats') || it.src.includes('streak-stats') || it.src.includes('skillicons')) ? '#0d1117' : 'transparent',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    padding: (it.src.includes('github-readme-stats') || it.src.includes('streak-stats')) ? '8px' : '0'
                  }}
                >
                  <img 
                    src={it.src} 
                    ...
                    alt={it.alt} 
                    style={{
                      objectFit: (it.src.includes('github-readme-stats') || it.src.includes('streak-stats') || it.src.includes('skillicons')) ? 'contain' : 'cover'
                    }} 
                  />
                </div>
              </div>
